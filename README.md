<html lang="fr">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="assets/synthese.pdf">Tableau de synthese</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://docs.google.com/spreadsheets/d/1jO7QbNtptC9W8EJzv_ujMoT-d6LHXOz-Am2p05DeRM4/edit#gid=0">Journal de bord</a></li>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Pale Mathy</div>
                <div class="masthead-heading text-uppercase">Portfolio BTS SIO</div>
                <div class="masthead-subheading">Option SLAM</div>
            </div>
        </header>
        <!-- Portfolio Grid-->
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/project.jpg" alt="..." />
                            </a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">Museum Vision</h2>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/museumvision.PNG" alt="..." />
